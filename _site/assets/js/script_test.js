...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const Wizard = (() => {
    ...
    const STYLE_MAP = {
      ...
      cv_web: [
    { value: 'moderno',       caption: 'Moderno',            img: 'assets/CV_Web_Maradona_preview.png' },
    { value: 'minimalista',   caption: 'Minimalista/Sobrio', img: 'assets/CV_Web_Maradona2_preview.png' } // 👈 nuevo
  ]
    };
